...
class SubEventController extends Controller
{
    ...
    public function show($event)
    {
        ...
        $event = SubEvent::where('id', $event)->with('event')->first();
            ...
            $badges = Badge::where('sub_event_id',$event->id)->where('is_printed',0)->where('badge_type_id',$delegate_badge->id)->where('is_hidden',0)->orderBy('created_at','desc')->paginate(25);
 ...
 */
    function search_delegates(Request $request){
        ...
        //search delegates
        $badges = Badge::where('sub_event_id', $event->id)
            ...
            $output .= '<tr>
                ...
                <td>';
                   if($badge->is_printed){
                       ...
                       $output .= '<span class="badge badge-sm bg-gradient-danger">No</span>';
                   }
            $output .= '</td>
                <td>
