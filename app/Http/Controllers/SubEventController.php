...
class SubEventController extends Controller
{
    ...
    public function show($event)
    {
        ...
        $event = SubEvent::where('id', $event)->with('event')->first();
            ...
            $badges = Badge::where('sub_event_id',$event->id)->where('is_printed',0)->where('is_hidden',0)->where('badge_type_id',$delegate_badge->id)->orderBy('created_at','desc')->paginate(25);
