          ...
          <div class="container z-10">
            <div class="flex flex-wrap mt-0 -mx-3">
              <div
                ...
                <div
                  class="relative flex flex-col min-w-0 mt-10 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border">
                  <div
              ...
              <div class="w-full max-w-full px-3 lg:flex-0 shrink-0 md:w-6/12">
                <div
                  ...
                  <div
                    ...
                    style="
                      background-image: url({{ asset('storage/curved6.jpg') }});
                    "></div>
                </div>
              </div>
            </div>
